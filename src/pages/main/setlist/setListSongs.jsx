...
import { setSetListSongToPlayId, setSetListSongs, setSetlistSongToPlayFull, setSetlistsArray } from '../../../store/slices/setlist-slice';
...
const SetlistSongs = () => {
    ...
    const playSongHandler = async (song) => {
        ...
        try {
            ...
            dispatch(setSetlistSongToPlayFull(song2.data.data))
