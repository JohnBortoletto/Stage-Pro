...
import { setRecentlyPlayedSongs, setSongToEdit, setSongToPlay, setSongToPlayFull, setSongToPlayId, setSongs, setSongsArray } from '../../../store/slices/song-slice';
  ...
  const playSongHandler = async (song) => {
    ...
    if (song.id)
      try {
        ...
        dispatch(setSongToPlayFull(song2.data.data));
        navigate('/player')
      } catch (error) {
        console.log(error);
      } finally {
