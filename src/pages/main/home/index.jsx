...
import { setLastPage, setRecentlyPlayedSongsArray, setSongToEdit, setSongToPlay, setSongToPlayFull, setSongToPlayId, setSongsArray } from '../../../store/slices/song-slice';
...
const Home = () => {
    ...
    const playSongHandler = (song) => {
        ...
        dispatch(setSongToPlayFull(song))
        navigate('/player')
    }
