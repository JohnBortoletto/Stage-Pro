...
const AddSong = () => {
    ...
    // extract lyrics from <li style="color: #ffffff">A club isn't the best place to find a lover</li>


    useEffect(() => {
        if (songToEdit) {

            const lyrics = iformData.lyrics.split('<li style="color: #ffffff">').map((line) => {
                return line.replace('</li>', '');
            });
