...
const Player = () => {
    ...
    const { setlistSongToPlayId, setListSongs ,setlistSongToPlayFull } = useSelector((state) => state.setlist);
    console.log({setlistSongToPlayFull});
    const { songToPlay, settings } = useSelector((state) => state.songs);
    const [color, setColor] = useState("#000000");
    const [loading, setLoading] = useState(false);
    const [fontColor, setFontColor] = useState(setlistSongToPlayFull.font_color);
    const [lineColor, setLineColor] = useState(fontColor);
    const [currentLine, setCurrentLine] = useState(0);
    const [value, setValue] = useState(30);
    const [speedAtStop, setSpeedAtStop] = useState();
    const [fontSize, setfontSize] = useState(setlistSongToPlayFull.font_size);
    const [playSpeed, setPlaySpeed] = useState(setlistSongToPlayFull.scroll_speed);
