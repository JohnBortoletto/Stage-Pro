...
const songsSlice = createSlice({
    ...
    reducers: {
        ...
        setSongToPlayFull: (state,action) => {
            state.songToPlayFull = action.payload;
        }
    },
});

export const { setSongs, setSongsArray, setSongToPlay, setSongToPlayId, setSettings, setSongToEdit, setRecentlyPlayedSongs, setRecentlyPlayedSongsArray, setLastPage, setSongToPlayFull } = songsSlice.actions;
